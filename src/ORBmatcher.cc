...
namespace ORB_SLAM3
{
    ...
    */
                                           ...
                                           vector<pair<size_t, size_t> > &vMatchedPairs, const bool bOnlyStereo, const bool bCoarse)
    {
        ...
        Eigen::Vector2f ep = pKF2->mpCamera->project(C2);//将3d投影
        //这里需要删除Tlr，Trl，Trr
        Sophus::SE3f T12;
        Sophus::SE3f Tll;
...
#else
{
        ...
        vector<int> rotHist[HISTO_LENGTH];
        for(int i=0;i<HISTO_LENGTH;i++)
            rotHist[i].reserve(500);//每个bin预分配500，可以自动填充
...
#else
{
    ...
    int ORBmatcher::DescriptorDistance(const cv::Mat &a, const cv::Mat &b)
    {
        ...
        return dist;
         ...
         void ORBmatcher:: setCheckOrientation(bool check) {
        mbCheckOrientation = check;
    }
    bool ORBmatcher:: getCheckOrientation() {
        return mbCheckOrientation;
    }
} //namespace ORB_SLAM
